...
PALETTE={8 0 13 26 1 2 11 20 3 6 15 16 9 18 12 24}
...
$(eval $(call IMG2SPRITES,assets/sorcerer2.png,0,g,10,12,$(PALETTE),,src/sprites/))
$(eval $(call IMG2SPRITES,assets/sentinel.png,0,g,10,12,$(PALETTE),,src/sprites/))
$(eval $(call IMG2SPRITES,assets/knight.png,0,g,10,12,$(PALETTE),,src/sprites/))
$(eval $(call IMG2SPRITES,assets/ghost.png,0,g,10,12,$(PALETTE),,src/sprites/))
$(eval $(call IMG2SPRITES,assets/bat.png,0,g,10,12,$(PALETTE),,src/sprites/))
$(eval $(call IMG2SPRITES,assets/door.png,0,g,10,12,$(PALETTE),,src/sprites/))
$(eval $(call IMG2SPRITES,assets/witch.png,0,g,10,12,$(PALETTE),,src/sprites/))
...
$(eval $(call IMG2SPRITES,assets/magic.png,0,g,8,8,$(PALETTE),,src/gfx/))

## Los siguientes se han cambiado a arrays, descomentar solo si es necesario compilar
##$(eval $(call IMG2SPRITES,assets/objects.png,0,g,8,8,$(PALETTE),,src/gfx/))
##$(eval $(call IMG2SPRITES,assets/font.png,0,g,6,8,$(PALETTE),,src/gfx/))
##$(eval $(call IMG2SPRITES,assets/explosion.png,0,g,10,12,$(PALETTE),,src/sprites/))
##$(eval $(call IMG2SPRITES,assets/dust.png,0,g,8,8,$(PALETTE),,src/sprites/))
##$(eval $(call IMG2SPRITES,assets/coin.png,0,g,6,8,$(PALETTE),,src/sprites/))
